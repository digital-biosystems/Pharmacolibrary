...
partial model PartialAbsorption "route interface: administered mass-flow in -> drug delivered at cport"
  ...
  parameter Modelica.Units.SI.Time Tlag(displayUnit = "min") = 0 "lag between administration and delivery; applied by the dose schedule (PeriodicDose starts its pulses Tlag later)";
