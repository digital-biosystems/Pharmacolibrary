...
model PK_3C_enteral
  ...
  annotation(
    ...
    Documentation(info = "<html><body>Generic 3-compartment model with enteral (oral, sublingual, buccal, rectal) dosage, adding <code>Tlag</code> (absorption delay) and <code>ka</code> (first-order absorption rate). Outputs concentration in the central and both peripheral compartments.</body></html>"));
end PK_3C_enteral;
